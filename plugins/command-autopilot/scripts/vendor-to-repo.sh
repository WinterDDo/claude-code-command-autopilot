...
cp "$PLUGIN/cloud/cloud-nudge.sh" "$TARGET/.claude/cloud-nudge.sh"
chmod +x "$TARGET/.claude/autopilot-cloud.sh" "$TARGET/.claude/cloud-nudge.sh"
...
echo "  PostToolUse (matcher \"Agent|Task|ExitPlanMode\") -> sh \"\$CLAUDE_PROJECT_DIR/.claude/cloud-nudge.sh\""
