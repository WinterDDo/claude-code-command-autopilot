...
Claude Code에는 약 100개의 내장 슬래시 명령어와 당신이 설치한 모든 스킬이 있는데, 가장 강력한 것들(오케스트레이션, 병렬 처리, 자율 실행)이 정확히 아무도 발견하지 못하는 것들입니다. Skill Autopilot은 세 가지 방식으로 그 간극을 메웁니다.
